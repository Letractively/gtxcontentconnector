...
public class CRRequest implements Cloneable, Serializable {
	 ...
	 * @param sortArray - sorting array e.g. String[]{"contentid:asc",
	 * "name:desc"}
	 * @param attributeArray - Attributes to fetch
	 * @param plinkAttributeArray - Attributes to perform plink replacement
	 * within
	 */
	public CRRequest(final String requestFilter, final String startString,
		...
		this(requestFilter, startString, countString, sortArray, attributeArray,
				plinkAttributeArray, null);
	}
	...
	/**
	 * Gets the configured request object.
	 * This method is deprecated use {@link CRRequest#getRequestWrapper()}
	 * instead.
	 * @return request
	 */
	@Deprecated
	 ...
	 * @param request the {@link ServletRequest} or the {@link PortletRequest}
	 */
	@Deprecated
	...
	/**
	 * Set the request object.
	 * @param requestWrapper RequestWrapper that holds the
	 * {@link ServletRequest} or the {@link PortletRequest}
	 */
