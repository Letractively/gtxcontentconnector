...
public class CRRecencyBoostingQuery extends CustomScoreQuery {
	 ...
	 */
	public CustomScoreProvider getCustomScoreProvider(AtomicReader r) throws IOException {
	...
	private class RecencyBooster extends CustomScoreProvider {
		 ...
		 * @throws IOException
		 */
		public RecencyBooster(final AtomicReader r) throws IOException {
			super(r.getContext());
			publishDay = FieldCache.DEFAULT.getInts(r, timestampField, true);
		}
